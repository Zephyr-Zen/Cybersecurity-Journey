...
- **Antimalware/Antivirus Software:** Software designed to protect devices and networks from malious software by blocking and/or destroying it.
...
- **Business Continuity:** The ability for a business to continue working despite having an incident.
## C
...
- **Code-Based Encryption:** Transforming data into encoded messages that are hard to decode without the correct algorithm.
...
- **Disaster Recovery:** The ability to get back to a functional state after an incident.
...
- **Hash-Based Encryption:** Transforming data into a character string via hash functions.
...
- **IoC (Indicators of Compromise):** Signs and signatures of attacker activity.
...
## L
- **Lattice-Based Encryption:** Using multidimensional geometric structures to encrypt data.
...
- **Live Tests:** Tests in which organisations shutdown critical systems to see how staff respond and the impact of the systems failing.
...
- **MITRE ATT&CK (Adversarial Tactics, Techniques, and Common Knowledge) Matrix:** A table of information created by MITRE based on tactics cyberattackers used, in order to help examine cyberattacks.
- **Multivariate Encryption:** Using many different math equations and variables simultaneously to encrypt data.
## N
...
- **Network Address:** The starting portion of an IP Address that identifies the network i.e *192.168.1*.1 .
## O
...
## P
- **Paper-Based Tests:** Surveys conducted by the security team to evalutate an organisations level of preparation for cyber attacks.
...
## T
- **Tabletop Test**: A incident response simulation involving key personnel.
